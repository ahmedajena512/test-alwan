      ...
      child: ScaleTransition(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: widget.isWished ? AppColors.mainGradient : null,
            color: widget.isWished ? null : Theme.of(context).cardColor,
          ...
          child: Icon(
            ...
            color:
                widget.isWished ? Colors.white : Theme.of(context).primaryColor,
            size: widget.size! - 4,
          ),
        ),
      ),
