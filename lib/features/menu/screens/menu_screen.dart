                ...
                Container(
                  ...
                  child: Column(children: [
                    ...
                    (Get.find<SplashController>()
                            ...
                            1)
                        ? PortionWidget(
                            icon: Images.pointIcon, title: 'loyalty_points'.tr,
                    ...
                    Get.dialog(
                        ConfirmationDialog(
                            ...
                            onYesPressed: () async {
                              ...
                              Get.back();
                              showCustomSnackBar('logout_successful'.tr,
                                  isError: false);
                            }),
                        useSafeArea: false);
                  } else {
    ...
    return Expanded(
      child: Container(
        decoration: BoxDecoration(
          ...
          border:
              Border.all(color: Theme.of(context).disabledColor, width: 0.2),
          boxShadow: const [
