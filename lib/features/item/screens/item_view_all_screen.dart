...
class ItemViewAllScreen extends StatefulWidget {
  ...
  const ItemViewAllScreen(
      {super.key, this.isPopular = false, this.isSpecial = true});
                ...
                child: Row(children: [
                  ...
                  Expanded(
                    ...
                    child: SearchFieldWidget(
                      ...
                      suffixIcon: itemController.isSearching
                          ? CupertinoIcons.clear_thick
                          : null,
                      iconPressed: () {
                        if (!itemController.isSearching) {
                          if (itemController.searchController.text
                              .trim()
                              .isNotEmpty) {
                            if (widget.isPopular) {
                              itemController.getPopularItemList(
                                  notify: true, offset: '1');
                            } else if (widget.isSpecial) {
                              itemController.getDiscountedItemList(
                                  notify: true, offset: '1');
                            } else {
              ...
              child: Stack(children: [
                ...
                Get.find<ItemController>().isAvailable(item)
                    ...
                    : const NotAvailableWidget(
                        radius: Dimensions.radiusDefault, isAllSideRound: true),
              ]),
            ),
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    discount != null && discount > 0
                        ...
                        : const SizedBox(),
                    SizedBox(
                        height: discount != null && discount > 0
                            ? Dimensions.paddingSizeExtraSmall
                            : 0),
                    ShaderMask(
