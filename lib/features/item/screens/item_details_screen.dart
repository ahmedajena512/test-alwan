...
class _ItemDetailsScreenState extends State<ItemDetailsScreen> {
  ...
  void initState() {
    ...
    Get.find<ItemController>().getItemDetails(
        itemId: widget.itemId, item: widget.isCampaign ? widget.item : null);
                                                  ...
                                                  QuantityButton(
                                                    ...
                                                    isExistInCart:
                                                        itemController
                                                                .cartIndex !=
                                                            -1,
                                                    cartIndex: itemController
                                                        .cartIndex,
                                                    quantityLimit: itemController
                                                                .cartIndex !=
                                                            -1
                                                        ? cartController
                                                            .cartList[
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: (quantity! == 1 && !isIncrement) || cartController.isLoading
              ? null
          ...
          color: (quantity! == 1 && !isIncrement) || cartController.isLoading
              ...
              : isIncrement
                  ? null
                  : Theme.of(context).disabledColor.withValues(alpha: 0.2),
          boxShadow: isIncrement && !cartController.isLoading
              ? [
                  BoxShadow(
                    color:
