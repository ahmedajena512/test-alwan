...
class OrderInfoWidget extends StatelessWidget {
    ...
    return Stack(children: [
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        CustomCard(
          ...
          child: Column(
              ...
              children: [
                ...
                _infoItem(context, parcel ? 'delivery_id'.tr : 'order_id'.tr,
                    '#${order.id}',
                    isBold: true),
                if (parcel && order.orderStatus == AppConstants.canceled)
                  _infoItem(
                      context,
                      'return_date_and_time'.tr,
                      order.parcelCancellation?.returnDate != null
                          ? DateConverter.dateTimeStringToDateTime(
                              order.parcelCancellation!.returnDate!)
                          : 'not_set_yet'.tr),
                _infoItem(context, 'order_date'.tr,
                ...
                if (order.orderStatus != 'canceled' &&
                  ...
                  _infoItem(
                      context, 'delivery_verification_code'.tr, order.otp ?? '',
                      isBold: true),
                _infoItem(
                    context,
                    'payment_method'.tr,
                ...
                if (order.orderStatus == 'delivered')
                  _infoItem(context, 'delivered_at'.tr,
                      DateConverter.dateTimeStringToDateTime(order.delivered!)),
                if (Get.find<SplashController>()
                    .getModuleConfig(order.moduleType)
                    .newVariation!)
                  _infoItem(context, 'cutlery'.tr,
                      order.cutlery! ? 'yes'.tr : 'no'.tr),
                if (order.unavailableItemNote != null)
                  _infoItem(context, 'unavailable_item_note'.tr,
        ...
        parcel && order.parcelCancellation != null
            ? CustomCard(
                ...
                child: Column(
                    ...
                    children: [
                      order.parcelCancellation!.returnFee != null &&
                          ...
                          ? Container(
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    Text('you_will_pay_return_fee'.tr,
                                        style: robotoRegular),
                                    Text(
                                        PriceConverter.convertPrice(order
                                            .parcelCancellation!.returnFee),
                                        style: robotoBold),
                                  ]),
                            )
                          : const SizedBox(),
                      SizedBox(
                          height: order.parcelCancellation!.returnFee != null &&
                                  order.parcelCancellation!.returnFee! > 0
                              ? Dimensions.paddingSizeSmall
                              : 0),
                      Container(
                        ...
                        child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                  order.parcelCancellation?.cancelBy
                                          ?.toTitleCase() ??
                                      '',
                                  style: robotoRegular),
                            ]),
                      ...
                      const SizedBox(height: Dimensions.paddingSizeSmall),
                      order.parcelCancellation?.reason != null &&
                              order.parcelCancellation!.reason!.isNotEmpty
                          ? Text('cancellation_reason'.tr,
                              style: robotoSemiBold)
                          : const SizedBox(),
                      SizedBox(
                          height: order.parcelCancellation?.reason != null &&
                                  order.parcelCancellation!.reason!.isNotEmpty
                              ? Dimensions.paddingSizeSmall
                              : 0),
                      order.parcelCancellation?.reason != null &&
                          ...
                          ? Container(
                              ...
                              child: Column(
                                ...
                                children: List.generate(
                                  order.parcelCancellation!.reason!.length,
                                  (index) {
                                    return Row(children: [
                                      Container(
                                        height: 5,
                      ...
                      SizedBox(
                          height: order.parcelCancellation?.reason != null &&
                              ...
                              ? Dimensions.paddingSizeSmall
                              : 0),
                      order.parcelCancellation?.note != null
                          ? Text('comments'.tr, style: robotoSemiBold)
                          : const SizedBox(),
                      SizedBox(
                          height: order.parcelCancellation?.note != null
                              ? Dimensions.paddingSizeSmall
                              : 0),
                      order.parcelCancellation?.note != null
                          ? Container(
                              ...
                              child: Text(order.parcelCancellation?.note ?? '',
                                  style: robotoRegular.copyWith(
                                      color: Theme.of(context)
                                          .textTheme
                                          .bodyLarge
            ...
            : const SizedBox(),
        SizedBox(
            height: parcel && order.parcelCancellation != null
                ? Dimensions.paddingSizeSmall
                : 0),
        !isDesktop
        ...
        (Get.find<SplashController>()
            ...
            ? CustomCard(
                ...
                child: Column(
                    ...
                    children: [
                      !isDesktop
                          ? Text('prescription'.tr, style: robotoSemiBold)
                          : const SizedBox(),
                      !isDesktop
                          ? const SizedBox(height: Dimensions.paddingSizeSmall)
                          : const SizedBox(),
        ...
        (order.orderStatus == 'delivered' &&
            ...
            : const SizedBox(),
        SizedBox(
            height: (order.orderStatus == 'delivered' &&
                    order.orderProofFullUrl != null &&
                    order.orderProofFullUrl!.isNotEmpty)
                ? Dimensions.paddingSizeSmall
                : 0),
        (order.deliveryMan != null && isDesktop)
            ...
            : const SizedBox(),
        SizedBox(
            height: (order.deliveryMan != null && isDesktop)
                ? Dimensions.paddingSizeSmall
                : 0),
        order.deliveryMan != null
            ? CustomCard(
                borderRadius: isDesktop ? Dimensions.radiusDefault : 15,
                isBorder: false,
                padding: EdgeInsets.all(Dimensions.paddingSizeDefault),
                child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('delivery_man_details'.tr,
                          style: robotoBold.copyWith(
                              fontSize: Dimensions.fontSizeLarge)),
                      const SizedBox(height: Dimensions.paddingSizeDefault),
                      Row(children: [
        ...
        SizedBox(
            height:
                order.deliveryMan != null ? Dimensions.paddingSizeSmall : 0),
        (parcel && isDesktop)
            ? CustomCard(
                borderRadius: isDesktop ? Dimensions.radiusDefault : 0,
                isBorder: false,
            ...
            : const SizedBox(),
        SizedBox(
            height: (parcel && isDesktop) ? Dimensions.paddingSizeSmall : 0),
        (!parcel && isDesktop)
        ...
        (!parcel && order.store != null)
            ...
            : const SizedBox(),
        SizedBox(
            height: (!parcel && order.store != null)
                ? Dimensions.paddingSizeSmall
                : 0),
        isDesktop
            ? Text(
          ...
          child:
            ...
            order.paymentMethod == 'offline_payment' ||
                ...
                : Row(children: [
                    ...
                    if (order.paymentMethod == 'offline_payment' ||
                        (order.paymentMethod == 'partial_payment' &&
                            orderController.trackModel!.offlinePayment != null))
                      Text(
                        orderController.trackModel!.offlinePayment != null
  ...
  Widget offlineView(BuildContext context, OrderController orderController,
      ExpansibleController controller, bool ongoing) {
    return Theme(
  ...
  Widget _infoItem(BuildContext context, String title, String value,
      {bool isBold = false, bool isTag = false}) {
    return Padding(
