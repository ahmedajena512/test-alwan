...
class _ParcelCategoryScreenState extends State<ParcelCategoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: isDesktop ? null : null, // AppBar is now in CustomScrollView
      body: GetBuilder<SplashController>(builder: (splashController) {
        return GetBuilder<ParcelController>(builder: (parcelController) {
          return GetBuilder<BannerController>(builder: (bannerController) {
            ...
            if (isDesktop) {
              return _buildDesktopBody(parcelController, bannerController,
                  showVideoAndServices, isDesktop, splashController);
            }
              ...
              child: RefreshIndicator(
                ...
                child: CustomScrollView(
                  slivers: [
                    ...
                    SliverToBoxAdapter(
                      child: _buildParcelContent(parcelController,
                          bannerController, showVideoAndServices, isDesktop),
                    ),
                  ],
                ),
              ),
        ...
        child: SingleChildScrollView(
          child: FooterView(
            child: SizedBox(
              ...
              child: _buildParcelContent(parcelController, bannerController,
                  showVideoAndServices, isDesktop),
            ),
          ),
        ),
      ),
    ...
    return Column(
      ...
      children: [
                    ...
                    itemBuilder: (context, index) {
                      return DeliverItemCardWidget(
                        ...
                        description: parcelController
                            .parcelCategoryList![index].description!,
                        onTap: () {
        ...
        Padding(
          padding: EdgeInsets.symmetric(
              horizontal: isDesktop ? 0 : Dimensions.paddingSizeLarge),
          child: bannerController.parcelOtherBannerModel != null &&
                  bannerController.parcelOtherBannerModel!.banners != null
              ? bannerController.parcelOtherBannerModel!.banners!.isNotEmpty
                  ? CarouselSlider.builder(
                      itemCount: bannerController
                          .parcelOtherBannerModel!.banners!.length,
        ...
        parcelController.whyChooseDetails != null
            ? isDesktop
                ? webExperienceView(isDesktop, parcelController)
                : mobileExperienceView(isDesktop, parcelController)
            : ParcelShimmer(
                isEnabled: parcelController.parcelCategoryList == null,
        ...
        Padding(
          padding: EdgeInsets.symmetric(
              horizontal: isDesktop ? 0 : Dimensions.paddingSizeLarge),
          child: parcelController.videoContentDetails != null
              ? isDesktop
                  ? Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                  ...
                  : Column(children: [
                      parcelController.videoContentDetails!.bannerType ==
                              'image'
                          ? ClipRRect(
                              borderRadius:
                          ...
                          : parcelController.videoContentDetails!.bannerType ==
                              ...
                              ? GetServiceVideoWidget(
                                  youtubeVideoUrl: parcelController
                                          .videoContentDetails!.bannerVideo ??
                                      '',
                                  fileVideoUrl: '',
                                )
                              : GetServiceVideoWidget(
