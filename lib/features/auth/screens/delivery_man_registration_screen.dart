...
class _DeliveryManRegistrationScreenState
  ...
  void initState() {
    ...
    Get.find<DeliverymanRegistrationController>()
        .dmStatusChange(DMRegistrationSteps.stepOne, isUpdate: false);
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) {
        if (Get.find<DeliverymanRegistrationController>().dmStatus !=
                DMRegistrationSteps.stepOne &&
            !didPop) {
          Get.find<DeliverymanRegistrationController>()
              .dmStatusChange(DMRegistrationSteps.stepOne);
          setState(() {
            _selectedIndex = 0;
          });
        } else {
...
/*CustomTextField(
                                                                  ...
                                                                  : Container(
                                                                      ...
                                                                      child: Column(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              'click_to_add'.tr,
                                                                              style: robotoMedium.copyWith(color: Colors.blueAccent, fontSize: Dimensions.fontSizeSmall),
                                                                              textAlign: TextAlign.center,
                                                                            ),
                                                                          ]),
                                                                    ),
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                child:
                                                                  ...
                                                                  child:
                                                                      Visibility(
                                                                    visible:
                                                                        deliverymanRegistrationController.pickedImage !=
                                                                            null,
                                                                    child:
                                                                        Center(
                                                                      child:
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Positioned(
                                                                          ...
                                                                          child:
                                                                              InkWell(
                                                                            onTap: () =>
                                                                                deliverymanRegistrationController.removeIdentityImage(index),
                                                                            child:
                                                                                Container(
                                                                              decoration: BoxDecoration(
                                                                                color: Theme.of(context).cardColor,
  ...
  Widget buttonView() {
    return GetBuilder<DeliverymanRegistrationController>(
      ...
      return CustomButton(
        ...
        buttonText: deliverymanRegistrationController.dmStatus ==
                DMRegistrationSteps.stepOne
            ? 'next'.tr
            : 'submit'.tr,
  ...
  Future<void> _submitData(
      DeliverymanRegistrationController
          deliverymanRegistrationController) async {
    if (deliverymanRegistrationController.dmStatus ==
            DMRegistrationSteps.stepOne &&
        !ResponsiveHelper.isDesktop(context)) {
      ...
      if (_formKeyStep1!.currentState!.validate()) {
        if (fName.isEmpty) {
          ...
          deliverymanRegistrationController
              .dmStatusChange(DMRegistrationSteps.stepTwo);
          setState(() {
            _selectedIndex = 1;
          });
        }
